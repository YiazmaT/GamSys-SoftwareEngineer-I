...
public class Loja extends javax.swing.JPanel {
    ...
    public Loja(Main pai,GamSys control) {
        ...
        loja.add(new Software("teste","teste descri", (float) 10.50,false,1));
        loja.add(new Software("teste2","teste2 descri", (float) 12.50,false,2));
        loja.add(new Software("teste3","teste3 descri", (float) 13.50,false,3));
        loja.add(new Software("teste4","teste4 descri", (float) 14.50,false,4));
        loja.add(new Software("teste5","teste5 descri", (float) 15.50,false,5));
    ...
    private void imprimir(ArrayList<Software> produtos){
        ...
        for(Software a : produtos){
            jPanel2.add(new ItenLoja(a,this,control.getUsuarioLogado().isAdmin(), control));
        }
        this.revalidate();
        this.repaint();
    }
